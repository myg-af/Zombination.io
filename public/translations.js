const TRANSLATIONS = {
  en: {
    ...
    send: 'Send',
    // Update placeholder to reflect increased character limit
    chatPlaceholder: 'Message (max 100)',
    chat: 'Chat',
  ...
  ru: {
    ...
    send: 'Отправить',
    chatPlaceholder: 'Сообщение (макс. 100)',
    chat: 'Чат',
    lobbyChat: 'Чат лобби',
  ...
  es: {
    ...
    // Placeholder for chat input reflecting the new 100 character limit
    chatPlaceholder: 'Mensaje (máx. 100)',
},
  pt: {
    login: 'Entrar',
    signup: 'Criar conta',
    ...
    send: 'Enviar',
    chatPlaceholder: 'Mensagem (máx. 100)',
    chat: 'Chat',
  ...
  de: {
    ...
    send: 'Senden',
    chatPlaceholder: 'Nachricht (max. 100)',
    chat: 'Chat',
    lobbyChat: 'Lobby-Chat',
    worldChat: 'Weltchat',
    zombination: "Zombination.io",
  ...
  pl: {
    ...
    send: 'Wyślij',
    chatPlaceholder: 'Wiadomość (max 100)',
    chat: 'Czat',
